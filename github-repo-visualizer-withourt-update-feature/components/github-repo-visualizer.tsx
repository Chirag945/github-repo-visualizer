    ...
    <div className="flex flex-col w-full space-y-6">
      ...
      {repoData && (
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
              ...
              <CardContent className="p-0 h-full">
                <div className="visualization-bg h-full w-full overflow-hidden">
                  {isLoading ? (
                    ...
                    <div className="h-full w-full flex items-center justify-center">
                      <div className="space-y-6 flex flex-col items-center">
                        <Database className="h-10 w-10 text-violet-500 animate-pulse" />
                        <p className="text-gray-500 dark:text-gray-400 animate-pulse-slow">
                    ...
                    <svg ref={svgRef} className="w-full h-full text-gray-800 dark:text-gray-200"></svg>
                  ) : (
                    <div className="h-full w-full flex items-center justify-center">
                      <div className="space-y-6 flex flex-col items-center max-w-md text-center p-6">
                        <div className="h-20 w-20 rounded-full bg-violet-100 dark:bg-violet-900/20 flex items-center justify-center transform transition-transform hover:scale-110 duration-300">
                          <Github className="h-10 w-10 text-violet-600 dark:text-violet-400" />
                        </div>
                        <div className="space-y-2">
                          ...
                          <p className="text-gray-500 dark:text-gray-400">
                            Enter a GitHub repository path (e.g., facebook/react) to visualize its structure as an
                            interactive graph.
                          </p>
                        </div>
                      </div>
                ...
                {selectedNode ? (
                  <div className="space-y-6">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <h2 className="text-xl font-bold text-gray-800 dark:text-gray-200 break-all">
                          {selectedNode.name}
                        </h2>
                        <Badge
                          variant="outline"
                          className={`mt-1 ${
                            selectedNode.type === "directory"
                              ? "bg-violet-100 dark:bg-violet-900/20 text-violet-600 dark:text-violet-400 border-violet-200 dark:border-violet-800"
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div className="space-y-3">
                        <div className="flex flex-col">
                          ...
                          <span className="font-mono text-sm bg-gray-50 dark:bg-gray-800 p-2 rounded mt-1 break-all">
                            {selectedNode.path || "/"}
                          </span>
                        </div>
                        ...
                        {selectedNode.type === "file" && (
                          <div className="flex flex-col">
                            ...
                            <span className="font-mono text-sm bg-gray-50 dark:bg-gray-800 p-2 rounded mt-1">
                      ...
                      {selectedNode.type === "directory" && selectedNode.stats && (
                        <div className="space-y-3">
                          <div className="flex flex-col">
                            ...
                            <span className="font-mono text-sm bg-gray-50 dark:bg-gray-800 p-2 rounded mt-1">
                              {selectedNode.stats.files}
                            </span>
                          </div>
                          <div className="flex flex-col">
                            <span className="text-sm font-medium text-gray-500 dark:text-gray-400">Directories</span>
                            <span className="font-mono text-sm bg-gray-50 dark:bg-gray-800 p-2 rounded mt-1">
                              {selectedNode.stats.directories}
                            </span>
                          </div>
                        </div>
                      )}
                    ...
                    {selectedNode._children && (
                      <div className="p-3 rounded-lg bg-amber-50 dark:bg-amber-900/20 text-amber-700 dark:text-amber-300 text-sm flex items-center">
                        <Info className="h-4 w-4 mr-2 flex-shrink-0" />
                        Node is collapsed. Double-click to expand.
                      </div>
                    )}
                    ...
                    <div className="flex flex-wrap gap-3">
                      <a
                        ...
                        className="inline-flex items-center px-4 py-2 rounded-lg bg-violet-100 dark:bg-violet-900/20 text-violet-700 dark:text-violet-300 hover:bg-violet-200 dark:hover:bg-violet-900/40 transition-colors"
                      >
                        <ExternalLink className="mr-2 h-4 w-4" />
                        View on GitHub
                      </a>

                      {repoInfo && selectedNode.type === "file" && (
                        <a
                          href={`https://raw.githubusercontent.com/${repoInfo.owner}/${repoInfo.repo}/${repoInfo.branch}/${selectedNode.path}`}
                          download={selectedNode.name}
                          target="_blank"
                          rel="noopener noreferrer"
                          className="inline-flex items-center px-4 py-2 rounded-lg bg-emerald-100 dark:bg-emerald-900/20 text-emerald-700 dark:text-emerald-300 hover:bg-emerald-200 dark:hover:bg-emerald-900/40 transition-colors"
                        >
                  ...
                  <div className="flex flex-col items-center justify-center py-12 text-center">
                    ...
                    <h3 className="text-lg font-medium text-gray-800 dark:text-gray-200 mb-2">No node selected</h3>
                    <p className="text-gray-500 dark:text-gray-400 max-w-md">
                      Click on a node in the visualization to view its details here
                    </p>
                  </div>
                )}
              </CardContent>
              ...
              <CardContent className="p-6">
                {selectedNode && repoInfo ? (
                  selectedNode.type === "file" ? (
                    <div className="space-y-6">
                      <div className="flex items-center gap-3">
                        <div className="h-12 w-12 rounded-lg flex items-center justify-center bg-emerald-100 dark:bg-emerald-900/20 text-emerald-600 dark:text-emerald-400">
                          <File className="h-6 w-6" />
                        </div>
                        <div>
                          <h2 className="text-xl font-bold text-gray-800 dark:text-gray-200 break-all">
                          ...
                          <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">{selectedNode.path}</p>
                        </div>
                      </div>

                      {!canFileBeSummarized(selectedNode.name) ? (
                        <div className="p-4 rounded-lg bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800">
                          <div className="flex items-start">
                            <AlertCircle className="h-5 w-5 text-amber-600 dark:text-amber-400 mt-0.5 mr-3 flex-shrink-0" />
                            <div>
                              <h3 className="font-medium text-amber-800 dark:text-amber-300">Unsupported File Type</h3>
                              <p className="text-amber-700 dark:text-amber-400 mt-1">
                                This file type cannot be summarized. Only code and text files are supported.
                              </p>
                              <p className="text-amber-600 dark:text-amber-500 text-sm mt-2">
                                Binary files, images, videos, and other non-text files cannot be processed by the AI
                                models.
                              </p>
                            </div>
                          </div>
                        </div>
                      ) : fileSummaries[`${repoInfo.owner}/${repoInfo.repo}:${selectedNode.path}`] ? (
                        <div className="space-y-4">
                          <div className="flex items-center justify-between">
                            <h3 className="text-lg font-medium text-gray-800 dark:text-gray-200">File Summary</h3>
                            <div className="flex items-center gap-2">
                              {fileSummaries[`${repoInfo.owner}/${repoInfo.repo}:${selectedNode.path}`].fromCache && (
                                <Badge
                                  variant="outline"
                                  className="bg-blue-100 dark:bg-blue-900/20 text-blue-700 dark:text-blue-300 border-blue-200 dark:border-blue-800"
                                >
                              ...
                              <Badge variant="outline" className="bg-gray-100 dark:bg-gray-800">
                                {fileSummaries[`${repoInfo.owner}/${repoInfo.repo}:${selectedNode.path}`].provider ===
                                "groq"
                                  ? "Groq"
                                  : "OpenAI"}
                              </Badge>
                          ...
                          <div className="bg-gray-50 dark:bg-gray-800/50 p-4 rounded-lg border border-gray-200 dark:border-gray-700">
                            <p className="text-gray-700 dark:text-gray-300 font-serif leading-relaxed whitespace-pre-line">
                              {fileSummaries[`${repoInfo.owner}/${repoInfo.repo}:${selectedNode.path}`].summary}
                            </p>
                          </div>
                          <div className="flex justify-between items-center">
                            <div className="text-xs text-gray-500 dark:text-gray-400 flex items-center">
                              ...
                              Generated on{" "}
                              {new Date(
                                fileSummaries[`${repoInfo.owner}/${repoInfo.repo}:${selectedNode.path}`].generatedAt,
                              ).toLocaleString()}
                            </div>

                            <Button
                              onClick={() => generateSummary(true)}
                              disabled={isSummarizing || (selectedProvider === "groq" ? !groqApiKey : !openaiApiKey)}
                              variant="outline"
                              size="sm"
                              className="text-xs"
                            >
                        ...
                        <div className="space-y-4">
                          <p className="text-gray-600 dark:text-gray-400">
                            Generate a summary to understand this file's purpose and structure without reading all the
                            code.
                          </p>
                            ...
                            >
                              {isSummarizing ? (
                                ...
                                <>
                                  ...
                                  Summarize File with {selectedProvider === "groq" ? "Groq" : "OpenAI"}
                                </>
                              )}
                            </Button>
                          </div>
                          ...
                          {selectedProvider === "groq" && !groqApiKey && (
                            <div className="text-sm text-amber-600 dark:text-amber-400 flex items-center">
                              ...
                              Please provide a Groq API key to enable file summarization
                            </div>
                          )}
                          ...
                          {selectedProvider === "openai" && !openaiApiKey && (
                            <div className="text-sm text-amber-600 dark:text-amber-400 flex items-center">
                              <AlertCircle className="h-4 w-4 mr-2" />
                              Please provide an OpenAI API key to enable file summarization
                            </div>
                          )}
                    ...
                    <div className="space-y-6">
                      <div className="flex items-center gap-3">
                        <div className="h-12 w-12 rounded-lg flex items-center justify-center bg-violet-100 dark:bg-violet-900/20 text-violet-600 dark:text-violet-400">
                          <Folder className="h-6 w-6" />
                        </div>
                        <div>
                          <h2 className="text-xl font-bold text-gray-800 dark:text-gray-200 break-all">
                      ...
                      {fileSummaries[`${repoInfo.owner}/${repoInfo.repo}:${selectedNode.path}`] ? (
                        <div className="space-y-4">
                          <div className="flex items-center justify-between">
                            <h3 className="text-lg font-medium text-gray-800 dark:text-gray-200">Directory Summary</h3>
                            <div className="flex items-center gap-2">
                              {fileSummaries[`${repoInfo.owner}/${repoInfo.repo}:${selectedNode.path}`].fromCache && (
                                <Badge
                                  variant="outline"
                          ...
                          <div className="flex justify-between items-center">
                            ...
                            <div className="text-xs text-gray-500 dark:text-gray-400">
                              Based on{" "}
                              {summarizedChildrenCount[`${repoInfo.owner}/${repoInfo.repo}:${selectedNode.path}`] || 0}{" "}
                              summarized items
                            </div>
                          </div>

                          <Button
                            onClick={() => generateDirectorySummary(true)}
                            disabled={
                              isSummarizingDirectory || (selectedProvider === "groq" ? !groqApiKey : !openaiApiKey)
                            }
                            variant="outline"
                            className="mt-2"
                          >
                            <RefreshCw className="h-4 w-4 mr-2" />
                            Refresh Directory Summary
                          </Button>
                        </div>
                      ) : (
                        <div className="space-y-4">
                          <p className="text-gray-600 dark:text-gray-400">
                            Generate a summary of this directory based on the summaries of its contents. You need to
                            summarize some files in this directory first.
                          </p>
                          ...
                          <div className="flex flex-col space-y-4">
                            ...
                            <Button
                              onClick={() => generateDirectorySummary(false)}
                              disabled={
                                isSummarizingDirectory || (selectedProvider === "groq" ? !groqApiKey : !openaiApiKey)
                              }
                              className="bg-gradient-to-r from-violet-600 to-indigo-600 hover:from-violet-700 hover:to-indigo-700 text-white"
                            >
                              {isSummarizingDirectory ? (
                                ...
                                <>
                                  ...
                                  Summarize Directory with {selectedProvider === "groq" ? "Groq" : "OpenAI"}
                                </>
                              )}
                            </Button>
                          </div>
                          ...
                          {selectedProvider === "groq" && !groqApiKey && (
                            <div className="text-sm text-amber-600 dark:text-amber-400 flex items-center">
                              <AlertCircle className="h-4 w-4 mr-2" />
                              Please provide a Groq API key to enable directory summarization
                            </div>
                          )}
                          ...
                          {selectedProvider === "openai" && !openaiApiKey && (
                            <div className="text-sm text-amber-600 dark:text-amber-400 flex items-center">
                              <AlertCircle className="h-4 w-4 mr-2" />
                              Please provide an OpenAI API key to enable directory summarization
                            </div>
                          )}
                  ...
                  <div className="flex flex-col items-center justify-center py-12 text-center">
                    ...
                    <h3 className="text-lg font-medium text-gray-800 dark:text-gray-200 mb-2">No file selected</h3>
                    <p className="text-gray-500 dark:text-gray-400 max-w-md">
                      Click on a file in the visualization to view or generate a summary
                    </p>
                  </div>
                )}
              </CardContent>
          ...
          <TabsContent value="sizes" className="mt-0">
            <Card className="overflow-hidden border-0 shadow-lg h-[600px] dark:bg-gray-800/30 backdrop-blur-sm">
              <CardContent className="p-6">
                {repoData ? (
                  <FileSizeDistribution data={repoData} />
                ) : (
                  <div className="text-center py-12">
                    <BarChart className="h-12 w-12 mx-auto text-gray-400 mb-4" />
                    <h3 className="text-lg font-medium mb-2">No repository data loaded</h3>
                    <p className="text-gray-500">Visualize a repository to see file size distribution</p>
                  </div>
                )}
              </CardContent>
            </Card>
                ...
                {isLoadingCommits ? (
                  ...
                  <div className="text-center py-8">
                    ...
                    <p className="text-gray-500 mb-4">
                      GitHub API rate limits may be restricting access to commit history.
                    </p>
                    <Button onClick={loadCommitHistory} className="mt-2">
                      Try Again
                    </Button>
                    {!token && (
                      <p className="text-sm text-gray-500 mt-4">
                        Tip: Adding a GitHub token may help overcome rate limits.
                      </p>
                    )}
                  </div>
                ) : commits.length > 0 ? (
                  ...
                  <div className="text-center py-12">
                    <GitCommit className="h-12 w-12 mx-auto text-gray-400 mb-4" />
                    <h3 className="text-lg font-medium mb-2">No commit history loaded</h3>
                    <p className="text-gray-500">Click the button below to load commit history</p>
                    <Button onClick={loadCommitHistory} className="mt-4" disabled={!repoData}>
                      Load Commit History
                    </Button>
                  </div>
                )}
      ...
      {repoData && (
        <DirectoryTreePopup
          ...
          apiKey={selectedProvider === "groq" ? groqApiKey : openaiApiKey}
        />
      )}
    </div>
  )
